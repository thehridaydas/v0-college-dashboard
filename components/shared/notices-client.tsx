...
const ROLE_COLOR: Record<string, string> = {
  ...
  PRINCIPAL: "bg-amber-500/10 text-amber-600",
}
...
export function NoticesClient({ notices: initial, classes, canCreate }: Props) {
      ...
      {notices.length === 0 ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-xs text-muted-foreground/60 mt-1">Published notices will appear here</p>
          </CardContent>
        </Card>
      ) : (
                  ...
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1 flex-wrap">
                        ...
                        <Badge className={`text-[10px] px-1.5 py-0 border-0 ${ROLE_COLOR[notice.createdByRole] ?? ""}`} variant="secondary">
        ...
        <DialogContent className="sm:max-w-lg">
          ...
          <div className="grid gap-4 py-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Select value={form.targetType} onValueChange={(v) => setForm({ ...form, targetType: v, targetId: "" })}>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleCreate} disabled={loading} className="bg-[#2E8B57] hover:bg-[#266b45] text-white gap-2">
              {loading && <Spinner className="w-4 h-4" />}Publish Notice
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>This will permanently delete this notice and notify all recipients it has been removed.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
