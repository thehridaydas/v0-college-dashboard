...
import {
  Plus, Search, MoreHorizontal, Pencil, Trash2, GraduationCap, Filter,
} from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="pt-4">
            <p className="text-2xl font-bold">{students.filter((s) => s.enrolledClass).length}</p>
        ...
        <Card>
          <CardContent className="pt-4">
            <p className="text-2xl font-bold text-amber-500">
              {students.reduce((a, s) => a + s.pendingFees, 0)}
            </p>
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-border/50">
                  <TableHead className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Student</TableHead>
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((student) => (
                    <TableRow key={student.id} className="hover:bg-muted/30 transition-colors">
                      ...
                      <TableCell>
                        <span className="text-sm font-mono text-muted-foreground">{student.rollNumber}</span>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <span className="text-sm text-muted-foreground">{student.parentName ?? "—"}</span>
                      </TableCell>
                      <TableCell>
                        {student.pendingFees > 0 ? (
                          ...
                          <Badge variant="secondary" className="text-xs bg-[#2E8B57]/10 text-[#2E8B57]">
                            Clear
                          </Badge>
                        )}
                      </TableCell>
