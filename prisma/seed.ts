...
async function main() {
  try {
    ...
    console.log("✓ Cleared noticeRecipient")
    await prisma.notice.deleteMany()
    console.log("✓ Cleared notice")
    await prisma.fee.deleteMany()
    console.log("✓ Cleared fee")
    await prisma.mark.deleteMany()
    console.log("✓ Cleared mark")
    await prisma.subjectAttendance.deleteMany()
    console.log("✓ Cleared subjectAttendance")
    await prisma.classAttendance.deleteMany()
    console.log("✓ Cleared classAttendance")
    await prisma.enrollment.deleteMany()
    console.log("✓ Cleared enrollment")
    await prisma.teacherAssignment.deleteMany()
    console.log("✓ Cleared teacherAssignment")
    await prisma.subject.deleteMany()
    console.log("✓ Cleared subject")
    await prisma.class.deleteMany()
    console.log("✓ Cleared class")
    await prisma.course.deleteMany()
    console.log("✓ Cleared course")
    await prisma.student.deleteMany()
    console.log("✓ Cleared student")
    await prisma.teacher.deleteMany()
    console.log("✓ Cleared teacher")
    ...
    const notice1 = await prisma.notice.create({
      data: {
        ...
        content: "Mid-term examinations will commence from 15th November 2024. Students are advised to prepare accordingly.",
    ...
    const notice3 = await prisma.notice.create({
      data: {
        title: "Staff Meeting",
        content: "All teaching staff is requested to attend the mandatory staff meeting on 20th October 2024 at 10:00 AM.",
        targetType: NoticeTarget.ROLE,
        targetId: "TEACHER",
